...
import { defaultFormDesign,parseFormDesign,safeCycleDocumentPath,safeLink } from './formDesign'
it('presents the choice explanation as optional in the default form',()=>{expect(defaultFormDesign.introduction).toContain('ההסבר הוא רשות')})
